package com.mbuildify.artisan.interfacess;
...
//    String PAYMENT_FAIL = "http://admin.mbuildify.com/Stripe/Payment/fail";
//    String PAYMENT_SUCCESS = "http://admin.mbuildify.com/Stripe/Payment/success";
//    String MAKE_PAYMENT = "http://admin.mbuildify.com/Stripe/Payment/make_payment/";

    String PAYMENT_FAIL_Paypal = "http://admin.mbuildify.com/Webservice/payufailure";
    String PAYMENT_SUCCESS_paypal = "http://admin.mbuildify.com/Webservice/payusuccess";

    String MAKE_PAYMENT_paypal = "http://admin.mbuildify.com/Webservice/mpesa?amount=400&userId=13&invoice_id=2GFKEU4X7K9N";
